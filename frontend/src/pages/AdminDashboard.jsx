          ...
          <div className="flex bg-white/5 rounded-xl p-1 border border-white/10">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-3 px-3 sm:px-4 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer ${
                  activeTab === tab.id
        ...
        <AnimatePresence>
          {toast && (
            <motion.div
              ...
              className={`fixed top-4 left-1/2 px-5 py-3 rounded-xl shadow-2xl text-sm font-medium z-50 ${
                toast.type === 'error'
